...
const velocidade1 = parseFloat(prompt("Qual velocidade o primeiro veiculo estava?"))

const veiculo2 = prompt("Qual o modelo do segundo veículo?")
const velocidade2 = parseFloat(prompt("Qual velocidade o segundo veiculo estava?"))
